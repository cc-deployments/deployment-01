...
export default function GalleryHero2() {
  ...
  const swipeHandlers = useSwipeable({
    onSwipedUp: async () => {
      console.log('⬆️ Swipe up detected - navigating to text-page-test');
      navigateTo('/text-page-test');
    },
    onSwipedDown: async () => {
      console.log('⬇️ Swipe down detected - navigating to gallery-hero-test');
      navigateTo('/gallery-hero-test');
    },
    onSwipedLeft: () => {
