...
import { useBaseAccount } from '../app/components/BaseAccountProvider';
import { useCallback } from 'react';

import { getBuyOptions, createBuyQuote } from './onramp-api';

/**
 * A component that wraps the FundModal component for OnRamp functionality
 *
...
export default function FundWallet({ onSuccess }: { onSuccess: () => void }) {
  const { address: evmAddress } = useBaseAccount();
