...
- [ ] **Button on text-page not working** - Interactive buttons on text-page need debugging and fixing
- [ ] **Investigate Social Identity button** - Social identity page button functionality needs investigation
